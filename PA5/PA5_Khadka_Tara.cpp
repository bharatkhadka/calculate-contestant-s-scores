/*
	Class:	 COSC-1436-21638
	Author:  Tara Khadka
	Date:	 03/20/2017
	Purpose: To calculate contestant's scores
*/
...
int main()
{
	...
	cout << "\nThis program calculates a performers final score.\n"
		<< "-------------------------------------------------\n\n";
...
void getJudgeData(double &Score)
{
	do
	{
		cout << "Please enter a judges score: ";
		cin >> Score;

		if (Score < 0 || Score > 10)
		{
			cout << "\nERROR!!!! INVALID SCORE.\n"
			  << "PLEASE ENTER JUDGES SCORE THAT IS GREATER THAN 0 AND LESS THAN 10. \n\n";
		}
